...
- (void)updateToolbar {
    ...
    NSString *separator = IDMPhotoBrowserLocalizedStrings(@"of");
    if (_separatorString != nil) {
      separator = _separatorString;
    }
		_counterLabel.text = [NSString stringWithFormat:@"%lu %@ %lu", (unsigned long)(_currentPageIndex+1), separator, (unsigned long)[self numberOfPhotos]];
	} else {
